...
Using this framework, we can clone the particles to create an entire system:
<img width="612" height="617" alt="image" src="https://github.com/user-attachments/assets/fc7761c3-ba41-4d4b-9ad2-921ec68b4333" />



Listed in the main directory are the data files used to generate the octahedral particles.
See /micelletest for the files used to run a sample micelle simulation on Amarel.
